...
<body>
		      ...
		      <ul class="nav navbar-nav navbar-left">
		        <li class="dropdown">
		          <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="loadChatMembers">
			          <span class="glyphicon"></span> 채팅 멤버
		        ...
		        <li class="dropdown">
		          ...
		          <ul id="inviteBtnArea" style="display:none;">
		          	<li><a href="#" id="inviteChat" >초대하기</a></li>
		          </ul>
		        </li>
		      </ul>
	...
	<div style="border:1px solid grey; width:450px; margin-top:50px;background-color:#819FF7;">
	       ...
	       <br/>
	       <input id="inputMsg" type="text" size="48" maxlength="4000" placeholder="보낼 메시지를 입력하세요." onkeydown="sendEnter()"/>
	       <input type="submit" value="보내기" onclick="send()" class="btn btn-success"/>
	</div>
</body>
	...
	$(document).ready(function() {
		...
		$("#inviteChat").click(function() {
			...
			$.ajax({
				...
				data : formData,
				success : function(data) {
					var inviteMsg = "<p align='center'><span style='background-color:#CEF6D8;'><strong>${memberId}</strong>님이 <strong>"+data+"</strong>님을 초대하였습니다.</span></p>";
    	...
    	$("#outChat").click(function() {
    		...
    		if (answer) {
    			var outMsg = "<p align='center'><span style='background-color:#CEF6D8;'><strong>${memberId}</strong>님이 나갔습니다.</span></p>";
